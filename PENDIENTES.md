...
| **P-79** | 🔴 **El sellado entra como sellado y sale como CARTA** (reporte del dueño con captura, 2026-09-11, sobre la app publicada `c8bee65`). Textual: «di de alta un producto como compra porque no jaló el precio de mercado directo, y cuando le puse precios desde M2 regresó a inventario de esta forma, como carta». En su cola «Listas para publicar», dos piezas que él capturó como **sellado** se pintan con forma de **single**: `INV-001944 Weedle — CHAOS RISING · 1 · NORMAL` e `INV-001945 Spinarak — PERFECT ORDER · 1 · NORMAL`, ambas origen `compra`, 11 sep 2026. Tres síntomas en uno, y conviene no confundirlos: **(a)** el precio de mercado no se resolvió solo al capturar, que es por lo que tuvo que darlo de alta como compra; **(b)** las dos salieron con **el mismo precio de venta, MX$1,300.00**, en sets distintos — la propia cola promete «no se capturan precios de venta aquí ni se heredan del costo de compra», así que o la promesa se rompe o el precio vino de otro lado; **(c)** la pieza **pierde su naturaleza de sellado** en algún punto entre la captura y el inventario. **Dinero ⇒ triple veredicto.** Emparentado con P-69 (el precio de mercado se pierde entre paso 1 y 2 al subir sellado) y P-46 (sync de sellado), pero (c) no lo cubre ninguno de los dos. | orquestador (mide) → backend/frontend según dónde caiga | **reportado 2026-09-11 por el dueño; medición en curso (NO MEDIDO por el orquestador al escribir esta fila)** | la medición arranca por el componente que pinta el subtítulo de la cola y por el alta por compra de un sellado; re-medir P-69 antes de enrutar |

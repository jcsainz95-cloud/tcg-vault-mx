 ...
 * MANUAL del admin. (v1.28 §4.26g: el costo de APORTACIÓN de sellado dejó de valuar por el
 * legacy 'sealed' — ahora rutea por esta clave de mercado vía el resolver H-1.)
 */

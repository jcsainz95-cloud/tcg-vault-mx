 ...
 *
 * ⛔ **`CardSetDTO` NO trae `logoUrl` y es normativo** (§4.40.5 «NO entra»): esta superficie es
 ...
 * retícula de tejas del cotizador** (§4.40.5/§4.40.6). El tipo propio es el candado: con él,

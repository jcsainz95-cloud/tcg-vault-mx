 ...
 * el bloque de estimados de §21.3 use **exactamente la misma celda** en vez de inventar una: el
 ...
 * de grado hipotético (§21.2). Es un ensanchamiento compatible: todos los usos previos pasan string.
 */
